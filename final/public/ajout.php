...
<div class="starter-template">
    <form method="post" action="">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="game_name" name="game_name" placeholder="XXX">
            <label for="titre">Prix</label>
            <input type="text" class="form-control" id="prix" name="prix" placeholder="20">
            <label for="titre">Game type</label>
            <input type="text" class="form-control" id="game_type" name="game_type" placeholder="MMO">
            <label for="titre">Image Jeux</label>
    ...
    if (!empty($_POST)) {
        ...
        $pdo1->exec("INSERT INTO games (game_name, prix, game_type, img) VALUES ('$_POST[game_name]', '$_POST[prix]', '$_POST[game_type]' , '$_POST[img]');");
